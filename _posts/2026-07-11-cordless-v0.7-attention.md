...
date: 2026-07-11 22:30:00 +0530
categories: ai4good showcase
tags: [ai4good, cli, terminal, coding-agents, claude-code, notifications]
image: /assets/img/2026-07-11-cordless-v0.7-attention/card.png
excerpt: "When you run eight Claude Code and Codex sessions at once, the hard part isn't starting them — it's knowing which one is waiting for you. cordless v0.7 infers each session's attention state (working / idle / waiting / bell / finished) from its output, badges and sorts them, and can ping your phone via ntfy — plus scrollback search, copy-last-output, and named workspaces."
---

{% assign img = '/assets/img/2026-07-11-cordless-v0.7-attention' %}
...
[![cordless v0.7 — attention state]({{ img | append: '/card.png' | relative_url }})](https://naveenneog.github.io/cordless/)
